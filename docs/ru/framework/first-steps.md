...
Этого достаточно для всех примеров ниже. Интеграции — MCP, поиск через Tavily,
HTTP-сервер, ACP, Langfuse — подключаются отдельными extras; полный список см. в
[руководстве по установке](../getting-started/installation.md).
...
Больше о тулах можно узнать в [документации по инструментам](Соцсети/_архив/AiConf/aiconf/sgr-agent-core/docs/ru/framework/tools.md)
